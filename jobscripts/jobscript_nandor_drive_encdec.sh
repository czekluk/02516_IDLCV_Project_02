...
LOG_FILE="$HOME_DIR/hpc_logs/output_drive_encdec.txt"

source /zhome/25/a/202562/.venv_deep_learning/bin/activate
python3 /zhome/25/a/202562/intro_deep_learning_in_computer_vision/02516_IDLCV_Project_02/src/main.py --dataset drive --models encdec > "$LOG_FILE" 2>&1
